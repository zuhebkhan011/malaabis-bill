...
export default function SavedInvoices({ invoices = [], onDelete, onBack, onEdit }) {
      ...
      <div className="bg-[#121212] p-5 rounded-2xl border border-[#4d4635]/15 flex flex-col md:flex-row gap-4 items-stretch md:items-center">
        ...
        <div className="flex-1 flex gap-2">
          ...
          <button
            ...
            className="h-11 w-11 rounded-xl border border-[#4d4635]/20 hover:border-primary/50 text-outline hover:text-primary transition-all duration-200 cursor-pointer flex items-center justify-center bg-[#1a1a1a]"
              ...
              >
                ...
                <div className="px-4 pb-4 flex gap-2 flex-wrap">
                  ...
                  <button
                    ...
                    className="flex-1 min-w-[80px] h-9 rounded-xl border border-primary/20 bg-primary/5 text-primary hover:bg-primary/10 text-xs font-semibold uppercase tracking-wider transition-all cursor-pointer flex items-center justify-center gap-1.5"
                  >
