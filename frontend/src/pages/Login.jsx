          ...
          <form className="flex flex-col gap-6 w-full" onSubmit={handleSubmit}>
            ...
            <div className="relative group">
              ...
              <select
                ...
                className="w-full bg-[#1C1C1C] border border-[#4d4635] rounded-lg px-4 py-3 text-on-surface focus:outline-none focus:ring-0 focus:border-primary transition-colors text-sm h-[56px] appearance-none cursor-pointer"
              >
                <option value="admin">Administrator (All Access)</option>
                <option value="manager">Manager (AI + Business)</option>
                <option value="staff">Cashier/Staff (Billing + Catalog)</option>
              </select>
              <span className="material-symbols-outlined absolute right-4 top-1/2 -translate-y-1/2 text-outline/50 group-focus-within:text-primary transition-colors pointer-events-none">
